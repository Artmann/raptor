...
**Raptor** is a lightweight embedding database built for the Bun runtime that stores text embeddings in an append-only JSONL file format. It provides semantic search capabilities using cosine similarity with the BGE-Base-EN embedding model (768 dimensions).
